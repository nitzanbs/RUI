...
import styles from './AddProductRequest.module.css';
...
const allowedSubcategories = [
    ...
    {
        name: "ספרים ומדיה", subcategories: [
            "אדריכלות ועיצוב",
            "אמנות וצילום",
            "אמנות ותחביבים",
            "ביוגרפיות וזכרונות",
    ...
    {
        name: "מכשירי חשמל", subcategories: [
            "CD, DVD, BlueRay",
            "אביזרי מחשב",
            "אביזרי רשת",
            "אביזרים לטאבלטים",
...
export default function ProductForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const productData = { ...productCard, imageUrl: img, category: category,subCategory: subCategories};
    ...
    return (
        ...
        <form onSubmit={handleSubmit} >
            <div>
                <h2>הוספת בקשה לתרומה</h2>
            </div>
            <Grid container spacing={2}>
                <Grid item xs={6}>
                    <TextField label="כותרת" fullWidth
                ...
                <Grid item xs={12}>
                    ...
                    <Autocomplete
                        ...
                        name="subCategory"
                        options={allowedSubcategories.find(mainCategory => mainCategory.name === category)?.subcategories.map(categoryData => categoryData)}
                        fullWidth0

                        renderInput={(params) => <TextField {...params} label="תת קטגוריה" />}
                ...
                <Grid item xs={6}>
                    ...
                    {img && (
                        <div>
                            <img src={img} alt="Uploaded" style={{ width: '100%', marginTop: '10px' }} />
                        </div>
                    )}
                </Grid>
            </Grid>
